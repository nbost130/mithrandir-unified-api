...
const DAILY_BREAD_LIST: Array<{
  ...
  },
  {
    ...
    wisdom:
      "All things — not just the pleasant ones — are under his sovereign care.",
  },
  {
    ...
    wisdom:
      "Each morning is a fresh grant of mercy — receive it before you earn it.",
  },
  {
  ...
  },
  {
    ...
    wisdom:
      "The race is already marked — run it looking forward, not sideways.",
  },
  {
    reference: "Micah 6:8",
    text: "He has shown you, O mortal, what is good. And what does the Lord require of you? To act justly and to love mercy and to walk humbly with your God.",
    wisdom:
      "Three words: justice, mercy, humility. The entire ethic in a sentence.",
  },
  {
    ...
    wisdom:
      "Light is released through generosity, not hoarded through caution.",
  },
  {
  ...
  },
  {
    ...
    wisdom:
      "Rest is found in yoke-partnership with Jesus, not in absence of work.",
  },
  {
  ...
  },
  {
    ...
    wisdom:
      "Peace is a by-product of a stayed mind, not a stable circumstance.",
  },
  {
  ...
  },
  {
    ...
    wisdom:
      "Delight reshapes desire — his gifts align with his own delight in us.",
  },
  {
...
export async function getTopTasks(token: string): Promise<TodoistTask[]> {
  // Fetch all active tasks — v1 filter param is unreliable, so filter client-side
  ...
  // Prefer P1 (priority 4) and P2 (priority 3); fall back to all tasks
  const highPriority = all.filter((t) => t.priority >= 3);
  const pool = highPriority.length > 0 ? highPriority : all;
